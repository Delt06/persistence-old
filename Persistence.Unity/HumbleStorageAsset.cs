namespace Persistence.Unity
{
    public abstract class HumbleStorageAsset : StorageAsset
    {
        ...
        public sealed override int GetInt(string key, int defaultValue = default)
        {
        ...
        private IStorage Storage
        {
            get
            {
                ...
                _storage = CreateStorage() ?? throw new StorageException($"{nameof(CreateStorage)} must return a non-null value.");
                return _storage;
            }
        }
    ...
    {
        protected sealed override IStorage CreateStorage()
        {
            return new T();
        }
    }
